# hertie-intro-to-data-science-f2025 - cohort control repo

This is the **`.github` repo** for the `hertie-intro-to-data-science-f2025` cohort org. It holds this cohort's configuration
